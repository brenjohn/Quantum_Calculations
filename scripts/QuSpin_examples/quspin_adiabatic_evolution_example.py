...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 30 13:02:14 2022
...
vs = np.logspace(-2.0, 0.0, num=20, base=10) # ramp speeds
...
def realization(vs, H_XXZ, basis, real):
    ...
    seed()      # the rng needs to be seeded for each parallel process
    ...
    # show time taken
    print("realization {0}/{1} took {2:.2f} sec".format(real+1,
                                                        n_real,
                                                        time()-ti))
